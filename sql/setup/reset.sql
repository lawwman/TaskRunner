...
DROP FUNCTION IF EXISTS getAvailableTaskers(varchar, TIMESTAMP, TIMESTAMP);
...
CREATE TABLE HasSkills (
    tEmail VARCHAR(100) REFERENCES Taskers ON DELETE CASCADE ON UPDATE CASCADE,
    sname VARCHAR(50) REFERENCES Skills ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE Tasks (
    ...
    ttype VARCHAR(50) NOT NULL REFERENCES Skills ON DELETE CASCADE ON UPDATE CASCADE,
	task_details VARCHAR(3000), -- Details of task 
	
    taskeeEmail VARCHAR(100) NOT NULL REFERENCES Taskees ON DELETE CASCADE ON UPDATE CASCADE,
    taskerEmail VARCHAR(100) REFERENCES Taskers ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE Bids (
	task_id BIGINT NOT NULL REFERENCES Tasks ON DELETE CASCADE ON UPDATE CASCADE, 
    taskeeEmail VARCHAR(100) NOT NULL REFERENCES Taskees ON DELETE CASCADE ON UPDATE CASCADE,
    taskerEmail VARCHAR(100) NOT NULL REFERENCES Taskers ON DELETE CASCADE ON UPDATE CASCADE,
